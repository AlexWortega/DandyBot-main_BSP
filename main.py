...
from Perlinmap import RLDungeonGenerator
SCALE = 1
DELAY = 50
...
class Board:
    ...
    def load_level(self):
        ...
        self.map = RLDungeonGenerator(30, 20)
        dg = self.map
        dg.generate_map()
        self.level_gold = dg.getgold()
        #dg.print_map()
        ...
        for p in self.players:
            x,y=dg.create_spawn()
            print(x,y)
            self.add_player(p, x,y)
            print(p, dg.create_spawn())
        self.update_score()
